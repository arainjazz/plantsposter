...
export const INITIAL_BLOCKS: Block[] = [
  ...
  },
  {
    ...
    y: 320,
    w: 600,
    text: "Songar sunrose · Songar rockrose",
    fontSize: 15,
    color: POSTER_MUTED,
    fontWeight: 400,
    fontFamily: "sans",
  ...
  },
  {
    ...
    y: 190,
    w: 460,
    text: "砾坡一岁  from new shoots to winter cushion",
    fontSize: 14,
    color: POSTER_INK,
    fontWeight: 600,
    fontFamily: "sans",
  ...
  },
  {
    ...
    h: 220,
    src: null,
    label: "全球分布图 (GBIF + POWO)",
  },
  {
    id: "sec-range-caption",
    type: "text",
    x: 720,
    y: 750,
    w: 460,
  ...
  // ── Field identification ──────────────────────────────────
  {
    ...
    y: 810,
    w: 460,
    text: "FIELD IDENTIFICATION · 识 别 手 记",
    fontSize: 15,
    color: POSTER_ACCENT,
    fontWeight: 700,
    fontFamily: "sans",
  ...
  { id: "trait-img-1", type: "image", x: 720, y: 875, w: 60, h: 60, src: null, label: "刺状枝端" },
  {
    id: "trait-1-title",
    type: "text",
    x: 790,
...
export function clonePage(page: PosterPage, name?: string): PosterPage {
  ...
  const speciesName = deriveAutoName(page.blocks) || page.name;
  return {
