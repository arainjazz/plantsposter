    ...
    >
      ...
      >
        ...
        >
          {hits.map((h) => (
            ...
            >
              ...
              />
              <div
                style={{ fontSize: 10, padding: 6, color: "#555", height: 46, overflow: "hidden" }}
              >
                <div
                  style={{
                    fontWeight: 600,
        ...
        <div style={{ fontSize: 10, color: "#999" }}>
          结果来自 Openverse（聚合 Flickr、维基共享、博物馆等）与 Wikimedia Commons — 均为 CC /
          公有领域许可，使用时请按图片许可注明来源与作者。
        </div>
      </div>
    </div>
  );
