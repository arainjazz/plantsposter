...
const copy = {
  ...
  "Ammopiptanthus mongolicus": {
    ...
    humSub: "保育档案让一株苗仍带着来源地 · Provenance Is Part of Conservation",
    hum: "沙冬青的迁地繁殖和种质保存应记录母株、地点与采种年份。脱离来源信息的苗木很难用于比较野外种群，保育不只是把植物移进苗圃。\nEx-situ plants should retain parent, place and collection-year records; without provenance, nursery stock cannot reliably represent or compare wild populations.",
  },
  "Potaninia mongolica": {
  ...
  "Artemisia ordosica": {
    ...
    humSub: "“鄂尔多斯”被写进植物名 · Ordos as a Botanical Place-Name",
    hum: "学名与中文名都把鄂尔多斯写进植物志。它在毛乌素沙地研究中反复出现，也让流沙、牧业和地方自然史有了一种可被追踪的植物坐标。\nBoth its scientific and Chinese names carry Ordos; repeated records from the Mu Us sands make it a botanical reference point for local environmental history.",
  },
  ...
  "Juniperus sabina": {
    ...
    hum: "文献记载其果实在新疆维吾尔医药中被称作“新疆圆柏实”，宋代《注医典》已有相关记录。它保留了新疆地方医药知识与植物命名相互交织的一段历史。\nLiterature records its fruit in Uyghur medicine as Xinjiang yuanbai shi, with a Song-era text cited—an intersection of local medical knowledge and plant naming.",
  },
  "Salix gordejevii": {
  ...
  "Caragana korshinskii": {
    ...
    humSub: "防护带与饲草利用需要错开节律 · Shelterbelt and Forage Have Different Rhythms",
    hum: "柠条在北方干旱区被编入防护带和补充饲草利用。平茬枝条、放牧和采种应错开，让灌丛有完整的恢复周期；这是一种把生产与植被更新放在一起的管理知识。\nIn northern drylands it serves both shelterbelts and forage. Coppicing, grazing and seed collection need separate seasons so shrubs retain a full recovery cycle.",
  },
  ...
  "Haloxylon ammodendron": {
    ...
    humSub: "梭梭林把防风固沙与地方生计并置 · Saxaul Stands Link Protection and Livelihood",
    hum: "在绿洲边缘与荒漠交通线上，梭梭林长期被经营为防风固沙植被。今天的人工林还承接药材栽培等生计尝试，评价时应同时计入水量和林分健康。\nAt oasis margins and along desert routes, saxaul stands have long been managed for windbreak and sand control; modern livelihood uses must also account for water and stand health.",
  },
  "Pugionium cornutum": {
  ...
  "Tugarinovia mongolica": {
    ...
    humSub: "1928 年被命名的荒漠地方植物 · A Desert Plant Named in 1928",
    hum: "革苞菊属在 1928 年发表。学名把阿拉善—内蒙古荒漠中的地方物种带入标本交换与全球植物分类网络，也留下了区域自然史的一页。\nPublished in 1928, the name carried an Alxa–Inner Mongolian desert plant into herbaria and global botanical classification.",
  },
  "Allium mongolicum": {
  ...
  "Cistanche deserticola": {
    ...
    humSub: "从野采药材到可追溯栽培 · From Wild Harvest to Traceable Cultivation",
    hum: "中国在 20 世纪 80 年代已开始肉苁蓉栽培。今天的关键是合法来源、寄主林健康和采收记录，而不是追逐单次高产；药材供应链也属于荒漠保护的一部分。\nCultivation began in China in the 1980s. Legal origin, healthy host stands and harvest records matter more than a single high yield.",
  },
  "Xanthoceras sorbifolium": {
    ...
    humSub: "北方庭院里的花木记忆 · A Spring Tree in Northern Courtyards",
    hum: "文冠果春季白花中央常由黄转红，曾以花和树形进入北方庭院、校园与道路绿化。它先是一种被观看和记忆的花木，再有现代产业赋予它的新角色。\nIts white spring flowers often shift from yellow to red at the centre; long valued in northern courtyards, campuses and streets, it was a remembered flowering tree before modern industry gave it new roles.",
  },
  "Prunus mongolica": {
  ...
  "Nostoc flagelliforme": {
    ...
    humSub: "“发财”谐音曾进入节庆餐桌 · A Lucky Homophone at the Feast",
    hum: "“发菜”因谐音“发财”曾进入北方节庆饮食和礼品文化。这段消费记忆说明，食物象征可以深刻改变一类荒漠生物的命运。\nIts lucky homophone once brought it into northern festive food and gift culture—a reminder that food symbolism can profoundly alter a desert organism's fate.",
  },
};
